...
chats = {}
day = 86400
bot_id = 371600958-- Your Bot USER_ID
   ...
   -----------------------------------------------------------------------------------------------
	...
	-----------------------------------------------------------------------------------------------
  	if text:match("^[Ss]hare$") and is_sudo(msg) then
       sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 12092226368, 'Milad', 'S', 371600958)
    end
	-----------------------------------------------------------------------------------------------
...
⭕️اطلاع از اعتبار باقی مانده :  وضعیت اعتبار*]]
   ...
   -----------------------------------------------------------------------------------------------
      if text:match("^[Pp]ayping$") and is_sudo(msg) then
        send(msg.chat_id_, msg.id_, 1, 'https://payping.ir/Raptor', 1, 'html')
   end
  end
  -----------------------------------------------------------------------------------------------
 end 
